...
\appsection{Quellcode-Repository}
\label{app:repository}

Der vollständige Quellcode, die trainierten Modelle, Evaluationsergebnisse sowie die Skripte zur Reproduktion aller Experimente sind öffentlich verfügbar unter:

\begin{center}
\url{https://github.com/FritzKoerner/autonomous_landing_drones_rl_bachelorthesis}
\end{center}

Das Repository enthält die Simulationsumgebungen, den kaskadierenden PID-Regler, die Trainings- und Evaluationsskripte, das finale Modell (Checkpoint~400) mit allen Evaluationsergebnissen sowie die Kontrollläufe (5~Seeds) zur statistischen Varianzanalyse.
