...
\begin{figure}[H]
    ...
    \caption[Fortschrittsbelohnung und SNäherungsbelohnung]{Fortschrittsbelohnung
    (links) und Näherungsbelohnung (rechts). Beide Komponenten steigen mit
    zunehmender Annäherung an das Ziel. WGeglättet mit EMA $\alpha = 0{,}9$.}
...
\begin{figure}[H]
    ...
    zunehmender Kollisionsvermeidung. Geglättet mit EMA $\alpha = 0{,}9$.}
...
\begin{figure}[H]
    ...
    Entscheidungsschritte pro Episode an. Geglättet mit EMA $\alpha = 0{,}9$.}
...
\begin{figure}[H]
    ...
    Wertverlust (rechts). Geglättet mit EMA $\alpha = 0{,}9$.}
