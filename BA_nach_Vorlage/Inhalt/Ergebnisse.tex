...
Es wurde ein Training von sechs verschiedenen Seeds durchgeführt. Jeder der sechs
...
für alle nachfolgenden Evaluierungen ausgewählt (\textit{Early Stopping}).
...
\textit{Zero-Shot}-Transfer in die Weinbergumgebung über 1\,000~Episoden. Der Agent
...
\begin{figure}[H]
    ...
    Phase-2-Evaluation (1\,000~Episoden, \textit{Zero-Shot}-Transfer).
...
Terrain-Kollisionsrate sinkt von 15,9\,\% auf 9,4\,\%, da ein Teil der Episoden
mit späten Terrain-Kollisionen nun frühzeitig als Erfolg beendet
