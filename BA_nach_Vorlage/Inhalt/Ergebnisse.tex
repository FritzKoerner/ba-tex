...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/seed_analysis/reward_seeds_overview.pdf}
    \caption[Belohnungsverlauf über 6~Seeds]{Kumulative Belohnung über
    6~Seeds mit identischen Hyperparametern. Schattierte Fläche:
    95\,\%-Bootstrap-Konfidenzintervall des Mittelwerts
    ($10\,000$~Resamples). EMA $\alpha = 0{,}9$.}
...
\begin{figure}[H]
    ...
    (links) und Erfolgsbelohnung (rechts), exemplarisch für Seed~0.
    Geglättet mit EMA $\alpha = 0{,}9$.}
