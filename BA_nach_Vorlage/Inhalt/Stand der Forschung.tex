...
\textcite{yangMonocularVisionSLAMBased2018} verfolgen einen modularen Ansatz, bei dem aus monokularer SLAM-Rekonstruktion sichere Landezonen identifiziert werden. Das System demonstriert Landungen ohne GNSS, weist jedoch aufgrund der Pipeline-Komplexität eine Landezeit von rund zwei Minuten auf.
...
\textcite{kimMonocularVisionbasedAutonomous2022} & Mono RGB, Tiefe & DQN & diskret & $\checkmark$ & Indoor & -- \\
...
\textcite{martiniPositionAgnosticAutonomousNavigation2022}\textsuperscript{a} & Tiefe & SAC & kont. & $\checkmark$ & Agrar & -- \\
\addlinespace
Eigene Arbeit\textsuperscript{b} & Tiefe, Zustand & PPO & kont. & $\checkmark$ & Agrar & $\checkmark$ \\
\bottomrule
\end{tabular}
...
\textsuperscript{b} Training in abstrakter Korridorumgebung; Evaluation in simuliertem Weinberg (Sim-to-Sim).
}
\end{table}
...
Keine der betrachteten Arbeiten kombiniert Präzisionslandung, aktive Hindernisvermeidung, tiefenbildbasierte Wahrnehmung und einen kontinuierlichen Aktionsraum in einer Agrarumgebung (vgl.\ Tabelle~\ref{tab:vergleich-sdf}).
