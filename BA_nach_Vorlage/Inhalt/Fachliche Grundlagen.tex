...
Policy-Gradient-Verfahren können durch zu große Strategieänderungen pro Optimierungsschritt destabilisiert werden, da die unter der alten Strategie gesammelten Erfahrungsdaten das Verhalten der aktualisierten Strategie nicht mehr abbilden \autocite{schulmanProximalPolicyOptimization2017}. Trust-Region-Methoden wie TRPO \autocite{schulmanTrustRegionPolicy2015} begrenzen daher die Schrittweite über eine KL-Divergenz-Schranke zwischen alter und neuer Strategie, erfordern dafür jedoch Approximationen zweiter Ordnung. \Fachbegriff{Proximal Policy Optimization} (PPO) \autocite{schulmanProximalPolicyOptimization2017} erzielt eine vergleichbare Stabilisierung allein durch eine geklippte Zielfunktion:
